...
export default function AflossersToewijzenPage() {
  console.log("🔧 AflossersToewijzenPage component geladen");
  ...
  function handleAssignToShip(aflosser: any) {
    console.log("🔧 handleAssignToShip aangeroepen voor:", aflosser.firstName, aflosser.lastName);
  ...
  function handleCreateAssignment() {
    console.log("🔧 handleCreateAssignment aangeroepen");
    console.log("🔧 selectedAflosser:", selectedAflosser);
