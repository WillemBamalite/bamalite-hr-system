...
export default function AflossersOverzicht() {
  const { crewDatabase: allCrewData, stats, updateData, forceRefresh, resetLocalStorage } = useCrewData()
  ...
  const getAflossers = () => {
    ...
    console.log('Aflossers found:', {
      hook: hookAflossers.length,
      localStorage: localStorageAflossers.length,
      total: uniqueAflossers.length
    });
  ...
  const handleCreateAssignment = () => {
    ...
    console.log("🔧 Selected aflosser:", selectedAflosser)
    console.log("🔧 Current assignments:", selectedAflosser.aflosserAssignments || [])
    ...
    console.log("🔧 Updated aflosser:", updatedAflosser)
  ...
  const handleCreateUnavailable = () => {
    ...
    console.log("🔧 Creating unavailable period:", unavailable)
    console.log("🔧 Selected aflosser:", selectedAflosser)
    console.log("🔧 Current absences:", selectedAflosser.aflosserAbsences || [])
