...
export default function ZiektePage() {
  ...
  const handleRecoveryConfirm = () => {
    ...
    try {
      ...
      console.log("🔧 RECOVERY UPDATE:", {
        crewId: recoveryRecord.crewMemberId,
        newStatus: updatedCrewMember.status,
        terugkeerDatum: recoveryDate,
        firstName: updatedCrewMember.firstName,
        lastName: updatedCrewMember.lastName
      })
