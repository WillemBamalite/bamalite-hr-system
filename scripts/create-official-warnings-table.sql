-- Official warnings for crew members (alcohol/drugs test)
...
CREATE TABLE IF NOT EXISTS public.official_warnings (
  ...
  test_type TEXT NOT NULL CHECK (test_type IN ('alcohol', 'drugs')),
  performed_by TEXT NOT NULL CHECK (performed_by IN ('W.van der Bent', 'L.Godde', 'BFT')),
