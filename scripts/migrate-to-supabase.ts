...
function convertCrewData(crewData: any) {
  return {
    ...
    ship_id: crewData.shipId,
    regime: crewData.regime,
    phone: crewData.phone || '',
    email: crewData.email || '',
    status: crewData.status,
    on_board_since: crewData.onBoardSince,
    thuis_sinds: crewData.thuisSinds,
    birth_date: crewData.birthDate,
...
function convertSickLeaveData(sickLeaveData: any) {
  return {
    ...
    start_date: sickLeaveData.startDate,
    end_date: sickLeaveData.endDate,
    certificate_valid_until: sickLeaveData.certificateValidUntil,
